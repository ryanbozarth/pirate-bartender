...
/***/ function(module, exports) {
	...
	$(function () {
	    ...
	    var Question = function Question(question, property) {
	        this.question = question;
	        this.property = property;
	    };
	
	    var Pantry = function Pantry(name) {
	        this.name = name;
	        this.contents = {};
	    };
	    ...
	    var Ingredient = function Ingredient(name, type) {
	        this.name = name;
	        this.type = type;
	    };
	    ...
	    var Worker = function Worker(name) {
	        this.name = name;
	        this.customers = {};
	    };
	    ...
	    var Drink = function Drink(name, ingredients) {
	        this.name = name;
	    ...
	    function askQuestions() {
	        ...
	        if (count < ryan.questions.length) {
	            ...
	            var answer = "<br><select id='userpref'><option value='yes'>Aye! That sounds great.</option><option value='no'>Nay, none of that.</option></select>";
